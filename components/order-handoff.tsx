...
export function OrderHandoff({ code, onClose }: { code: string; onClose: () => void }) {
  ...
  return createPortal(
    <div className="order-modal-backdrop fixed inset-0 z-[100] grid h-[100dvh] w-screen place-items-center overflow-y-auto bg-background/80 p-4 backdrop-blur-sm" role="dialog" aria-modal="true" aria-label="Your order code">
      <div className="order-modal-card w-full max-w-md rounded-2xl border border-border bg-card p-6 shadow-2xl">
