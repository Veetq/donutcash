...
export function OrderHandoff({ code, onClose }: { code: string; onClose: () => void }) {
  ...
  return (
    <div className="order-modal-backdrop fixed inset-0 z-[100] grid place-items-center bg-background/80 p-4 backdrop-blur-sm" role="dialog" aria-modal="true" aria-label="Your order code">
